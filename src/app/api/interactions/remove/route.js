...
export async function POST(request) {
  try {
    console.log("Remove interaction API - Using mock data for demonstration");
    ...
    try {
      // Mock interaction removal for demonstration
      console.log(
        `Mock removing interaction: ${type} for ${itemType} item ${itemId}`
      );

      return NextResponse.json({
        success: true,
        message: "Interaction removed successfully (mock data)",
      });
    } catch (error) {
