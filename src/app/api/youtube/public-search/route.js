...
/**
 * Public YouTube Channel Search API
 * Bu endpoint authentication gerektirmeden YouTube kanal araması yapabilmek için
 * özel olarak tasarlanmıştır ve AddFeedDialog bileşeni tarafından kullanılır.
 */

export async function POST(request) {
  console.log("Public YouTube kanal arama API çağrıldı");
  ...
  try {
    ...
    // İlk sonucu ana kanal olarak döndür, tüm sonuçları da listeye ekle
    ...
    return NextResponse.json({
      ...
      channel: {
        ...
        thumbnail: primaryChannel.thumbnail || "",
        url: `https://youtube.com/channel/${primaryChannel.id}`,
        subscribers: "Bilinmiyor", // API bu bilgiyi doğrudan vermez
        videoCount: "0", // API bu bilgiyi doğrudan vermez
      },
...
export async function GET(request) {
  console.log("Public YouTube kanal arama servisi GET çağrıldı");
  ...
  return NextResponse.json({
    status: "Public YouTube kanal arama servisi çalışıyor",
