...
export function ReadLaterContent() {
  ...
  const { readLaterItems: items, isLoading, error, toggleFavorite, toggleReadLater } = useFeedService();
      ...
      <div className="relative z-10 px-4 md:px-8">
        <header className="w-full max-w-screen-2xl mx-auto mt-0 md:mt-8 mb-4 md:mb-6 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            <Bookmark className="h-5 w-5 md:h-7 md:w-7 text-blue-600 shrink-0" />
            <div>
